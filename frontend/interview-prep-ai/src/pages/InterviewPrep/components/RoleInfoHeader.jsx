    ...
    return (
        ...
        <div className="bg-white relative">
            <div className="container mx-auto px-10 md:px-0">
                <div className="h-[200px] flex flex-col justify-center relative z-10 ">
                        ...
                        <div className="flex-grow">
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <p className="text-sm text-medium text-gray-900 mt-1">{topicsToFocusOn}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center  gap-3 mt-4">
                        <div className="text-[10px] font-semibold text-white bg-black px-3 py-1 rounded-full">
                            Experience: {experienceLevel}  {experienceLevel == "Senior" && "(10+ years)"} {experienceLevel == "Mid" && "(3-10 years)"} {experienceLevel == "Junior" && "(0-3 years)"}
                ...
                <div className="w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-10">
